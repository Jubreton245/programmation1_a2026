...
prenom = "Justin"            # str, au moins 2 caracteres
nom_famille = "Breton"       # str, au moins 2 caracteres
age = 18               # int, strictement positif
moyenne_generale = 100.0  # float, entre 0.0 et 100.0
